...
router.get('/sessions', async (req, res) => {
    try {
        const sessions = await wahaSyncService_1.WahaSyncService.syncAllSessions();
        res.json(sessions);
    }
    catch (error) {
...
router.post('/sessions', async (req, res) => {
    try {
        ...
        const result = await wahaSyncService_1.WahaSyncService.createSession(name);
        res.json(result);
    }
    catch (error) {
...
router.post('/sessions/:sessionName/start', async (req, res) => {
    try {
        const { sessionName } = req.params;
        const result = await wahaSyncService_1.WahaSyncService.startSession(sessionName);
        res.json(result);
    }
    catch (error) {
...
router.post('/sessions/:sessionName/stop', async (req, res) => {
    try {
        const { sessionName } = req.params;
        const result = await wahaSyncService_1.WahaSyncService.stopSession(sessionName);
        res.json(result);
    }
    catch (error) {
...
router.post('/sessions/:sessionName/restart', async (req, res) => {
    try {
        const { sessionName } = req.params;
        const result = await wahaSyncService_1.WahaSyncService.restartSession(sessionName);
        res.json(result);
    }
    catch (error) {
...
//# sourceMappingURL=waha_old.js.map