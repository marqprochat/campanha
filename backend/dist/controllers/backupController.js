...
class BackupController {
    ...
    static async scheduleBackup(req, res) {
        try {
    ...
    static async listSystemBackups(req, res) {
        try {
    ...
    static async restoreSystemBackup(req, res) {
        try {
    ...
    static async configureSystemBackup(req, res) {
        try {
    ...
    static async getSystemBackupConfig(req, res) {
        try {
    ...
    static async downloadSystemBackup(req, res) {
        try {
    ...
    static async uploadSystemBackup(req, res) {
        try {
