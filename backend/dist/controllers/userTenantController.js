...
exports.UserTenantController = void 0;
...
class UserTenantController {
    ...
    static async addUserToTenant(req, res) {
        try {
    ...
    static async removeUserFromTenant(req, res) {
        try {
    ...
    static async getUserTenantsById(req, res) {
        try {
    ...
    static async updateUserTenantRole(req, res) {
        try {
            const { userId, tenantId } = req.params;
            const { role } = req.body;
...
exports.UserTenantController = UserTenantController;
