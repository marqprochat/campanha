...
const tenantSettingsService_1 = require("./tenantSettingsService");
class OpenAIService {
    static instance;
    ...
    async generateMessage(messageConfig, contactData = {}, tenantId) {
        try {
            ...
            const tenantSettings = await tenantSettingsService_1.tenantSettingsService.getTenantSettings(tenantId);
...
exports.openaiService = OpenAIService.getInstance();
