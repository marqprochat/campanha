...
exports.sendMessageViaEvolution = sendMessageViaEvolution;
exports.checkContactExistsEvolution = checkContactExistsEvolution;
...
async function sendMessageViaEvolution(instanceName, phone, message) {
    try {
        const config = await settingsService_1.settingsService.getEvolutionConfig();
...
async function checkContactExistsEvolution(instanceName, phone) {
    try {
        const config = await settingsService_1.settingsService.getEvolutionConfig();
        if (!config.host || !config.apiKey) {
...
//# sourceMappingURL=evolutionMessageService.js.map